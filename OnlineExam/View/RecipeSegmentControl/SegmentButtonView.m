...
- (SegmentButtonView *)initWithTitle:(NSString *)title
    ...
    if (self) {
        ...
        self.imageView.frame = CGRectMake(0, TOP_OFFSET, self.normalImage.size.width, self.normalImage.size.height);
        ...
        // Set up title
        self.label = [[UILabel alloc] initWithFrame:CGRectMake(0, self.normalImage.size.height/2 , self.normalImage.size.width, 20)];
